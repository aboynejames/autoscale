...
ethereurmjsAPI.prototype.setPublickey = function(epubkey) {
  ...
  this.publicaccount = '52bddcd1897e2b7516b2218e69fda38c017c29b9';
	this.web3.eth.defaultAccount = '52bddcd1897e2b7516b2218e69fda38c017c29b9';
	this.checkAccounts();
...
ethereurmjsAPI.prototype.recallStorageContract = function(action, smcontractIN) {
  ...
  else if(action == "set-permission")
  {
    ...
    var buildtext = {};
    sendDHTmessage.pubethk = smcontractIN.pubethk;
    sendDHTmessage.scid = smcontractIN.scid;
...
//console.log(abi);
  var myContract;
	var myContract = this.web3.eth.contract(abi);
console.log('before contr');
var myContract = myContract.at(contractID);

  // what action required on Dmap contract
  if(action == "sample-chosen")
  {
    console.log('loooooggggg next sample same dmap contract');
    myContract.setDsampling('0x94827d823aeea0017480b87df86aaa3e98d09378');
    myContract.setDscoring(78922, 98722);
//console.log('chosen');
...
console.log(' after chosen');
    ...
    // running count of number sample-chosen
    var currentCount = myContract.getDsamplingCount();
console.log('current count of chosens');    
console.log(currentCount);
    localthis.emit("sample-next", contractID, nodeClass);
...
console.log(returnDmap);
  ...
  else if(action == "set-invite-peer")
  {
    ...
    var invitePeerset = mysamplingContract.setPeerInvite(pubkeyeth);
